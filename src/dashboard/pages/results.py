...
**Remember:** This tool provides guidance, but professional legal advice is recommended for critical decisions.
    ...
    st.markdown("""
    <div style='border: 1px solid #2c5282; padding: 1.5rem; background-color: #ffffff; margin-bottom: 1.5rem;'>
        <h3 style='margin: 0 0 0.75rem 0; color: #2c5282;'>Generate Legal Documents</h3>
        <p style='margin: 0 0 1rem 0; font-size: 0.95rem; color: #495057; line-height: 1.5;'>
            Generate DPDP-compliant legal document templates (Privacy Notice, Consent Form, 
            Retention Schedule, Breach Notifications, etc.) pre-filled with your business information.
        </p>
        <p style='margin: 0 0 1rem 0; font-size: 0.85rem; color: #6c757d;'>
            <strong>Documents available:</strong> Privacy Notice, Consent Form, Grievance Procedure, 
            Retention Schedule, Breach Notification Templates, Parental Consent (if applicable), 
            Processor Agreement Checklist (if applicable)
        </p>
        <p style='margin: 0; font-size: 0.8rem; color: #868e96;'>
            Estimated cost savings: Rs. 1,15,000 - 2,10,000 compared to law firm drafting fees
        </p>
    </div>
    ...
    with col2:
        if st.button("Go to Document Generation", use_container_width=True, type="primary"):
